...
<div id="costs-section" class="space-y-4">
    ...
    <div class="card bg-base-100 shadow">
        <div class="card-body p-4">
            ...
            <div class="divider my-4">ขั้นตอนการรับบัตรและชำระเงิน</div>

            <div class="space-y-3">
                <!-- Card for Army Personnel -->
                <div class="card bg-base-200 border shadow-inner">
                    <div class="card-body p-4">
                        <h3 class="font-semibold flex items-center gap-3 text-sm">
                ...
                <div class="card bg-base-200 border shadow-inner">
                    <div class="card-body p-4">
                        <h3 class="font-semibold flex items-center gap-3 text-sm">
                            <i class="fa-solid fa-user-group text-secondary text-lg"></i>
