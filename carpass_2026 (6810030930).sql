...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 03, 2025 at 04:27 AM
...
(1, '', 'pommin_in', '$2y$10$44Vq4tXrMAtkr9qmzabz8.TZcBuq9CaMjusx41ugB/Osvm2Yvpra2', 'ร.ท.', 'พรหมินทร์', 'อินทมาตย์', '0875692155', 'น.ควบคุมข้อมูล', 'กยข.กช.', 'superadmin', 1, NULL, '2025-09-03 16:22:12'),
(2, '', 'admin01', '$2y$10$jrx4ptYPemIY7MOgIC/QruFL2oZdmXBs1CsTmnkrOUcqbSu7AZCYK', 'ร.ท.', 'รักชาติ', 'ยิ่งชีพ', NULL, NULL, 'กยข.กช.', 'admin', 0, 1, '2025-10-02 07:34:39');
...
CREATE TABLE `application_periods` (
  ...
  `card_fee` int(11) NOT NULL DEFAULT 30 COMMENT 'ค่าธรรมเนียมบัตรผ่านสำหรับรอบนี้',
...
INSERT INTO `application_periods` (`id`, `period_name`, `start_date`, `end_date`, `card_expiry_date`, `card_fee`, `is_active`) VALUES
(1, 'รอบปี 2569', '2024-10-01', '2026-10-01', '2026-12-31', 30, 1),
(2, 'รอบปี 2570', '2026-10-01', '2027-10-01', '2027-12-31', 30, 0);
