...
<body class="bg-gray-100">
    <div class="min-h-screen flex flex-col items-center justify-center text-center p-4">
        <div class="max-w-md">
            ...
            <h2 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">ไม่พบหน้าที่คุณค้นหา</h2>
            <p class="mt-4 text-base text-gray-500">ขออภัย, เราไม่พบหน้าที่คุณกำลังมองหา<br>อาจเป็นเพราะ URL ไม่ถูกต้องหรือหน้านั้นถูกย้ายไปแล้ว</p>
            <div class="mt-6">
